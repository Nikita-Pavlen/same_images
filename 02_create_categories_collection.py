...
schema = CollectionSchema(fields, description="Category main images for leader clustering")
...
print(f"  Fields: id (auto), category_id (VARCHAR/UUID), embedding (FLOAT_VECTOR, dim={CLIP_DIM})")
